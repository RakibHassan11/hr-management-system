...
import { useTeamAttendance } from "@/features/team/hooks/useTeam";

import { AttendanceRequest } from "@/features/team/types";
...
const TeamAttendanceRecord = () => {
  ...
  const { requests, loading, error, fetchRequests, updateStatus } = useTeamAttendance(managerId || null);
