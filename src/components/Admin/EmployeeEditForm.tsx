          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={profile.permission_value || '2'}
              ...
              <table className="w-full border-collapse border border-gray-300">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="py-2 px-4 border border-gray-300">
                      <Input
                        value={profile.annual_leave_balance || ''}
                        onChange={(e) =>
                          setProfile({ ...profile, annual_leave_balance: e.target.value })
                        }
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-2 px-4 border border-gray-300">
                      <Input
                        value={profile.sick_leave_balance || ''}
                        onChange={(e) =>
                          setProfile({ ...profile, sick_leave_balance: e.target.value })
                        }
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="py-2 px-4 border border-gray-300">
                      <Input
                        value={profile.casual_leave_balance || ''}
                        onChange={(e) =>
                          setProfile({ ...profile, casual_leave_balance: e.target.value })
                        }
                      />
                    </td>
                  </tr>
