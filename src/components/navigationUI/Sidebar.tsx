          ...
          {filteredMenuItems.map(item => {
            ...
            return (
              <li key={item.path}>
                <Link
                  to={item.path}
                  className={`flex items-center ${isCollapsed ? 'justify-center px-2' : 'gap-2 px-3'} py-2 rounded-lg  ${isActive ? 'bg-[#F97316] text-white' : 'text-[#1F2328] hover:bg-[#F97316]/10 hover:text-[#F97316]'
                    }`}
                >
