...
//             const outTime =
//               outMoment.isValid() && outMoment.isAfter(inMoment)
...
//               <td className="flex py-2 px-4 font-medium border border-gray-300">
//                 Check-in
//               </td>
//               {attendanceRecords.map(record => (
//                 <td
...
//             </tr>
//             <tr className="text-center">
//               <td className="py-2 px-4 font-medium border border-gray-300 flex">
//                 Duration
//               </td>
//               {attendanceRecords.map(record => (
//                 <td
//                   key={`${record.date}-duration`}
//                   className="py-2 px-4 border border-gray-300"
//                 >
