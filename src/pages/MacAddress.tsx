      ...
      <div className="p-6 bg-white text-[#1F2328] min-h-screen">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-300 mb-6">
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium">Official Laptop's Mac:</label>
              <Input type="text" className="w-full border border-gray-300" defaultValue="A0:51:0B:41:A6:31" readOnly />
            </div>
            <div>
              <label className="block text-sm font-medium">Personal Device's Mac:</label>
              <Input type="text" className="w-full border border-gray-300" defaultValue="48:01:C5:AA:10:A7" readOnly />
            </div>
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-300">
          <h2 className="text-lg font-semibold mb-4">Collection of MAC Address</h2>
          <div className="space-y-4">
            <div>
