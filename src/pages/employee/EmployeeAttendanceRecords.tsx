...
import { formatDate, formatText, formatTime } from '@/components/utils/dateHelper';
...
;
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-[#1F2328] mb-6">Employee Attendance Records</h1>
            ...
            {isLoading ? (
              ...
              currentRecords.map((record) => (
                <TableRow key={record.id}>
                  <TableCell className="text-[#1F2328] font-medium">{record.employee_name || record.employee_id}</TableCell>
