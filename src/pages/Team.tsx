...
const TeamPage = () => {
  ...
  return (
    <div className="animate-fadeIn p-6">
      <h1 className="text-3xl font-bold text-[#1F2328] mb-6">Team Members</h1>
      <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-[#1F2328]/30">
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              <TableRow>
                <TableCell colSpan={4} className="text-center text-[#1F2328]">Loading...</TableCell>
              </TableRow>
              ...
              <TableRow>
                <TableCell colSpan={4} className="text-center text-[#1F2328]">No team members available</TableCell>
              </TableRow>
            )}
          </TableBody>
        </Table>
